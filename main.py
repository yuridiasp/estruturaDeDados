...
if menu == 10:
    arvore_teste = Arvore()
    print(arvore_teste)
    arvore_teste.inserir_elemento(NoArvoreInteiro(5))
    arvore_teste.inserir_elemento(NoArvoreInteiro(4))
    arvore_teste.inserir_elemento(NoArvoreInteiro(6))
    arvore_teste.inserir_elemento(NoArvoreInteiro(8))
    arvore_teste.inserir_elemento(NoArvoreInteiro(7))
    #print(arvore_teste)
    #print(arvore_teste.buscar(NoArvoreInteiro(1)))
    print("Em ordem")
